...
export default function Filter({ profile, setProfile, location, setLocation, stipend, setStipend, handleToggleFilter }) {
    const ClearFun = () => {
        setProfile("");
        setLocation("");
        setStipend(0);
    ...
    return (
        <div className=" sticky top-20">
            <div className="block lg:hidden flex flex-col p-[40px] gap-5">
                ...
                <div className=" border border-2 border-[#333333] p-[20px]">
                ...
                <div className="flex justify-center mt-4 bg-[#00A5EC] rounded-[5px] p-2">
                    <button
                        className="text-white text-[22px]"
                        onClick={() => {
                            if (typeof handleToggleFilter === 'function') handleToggleFilter();
                        }}>
                        Apply
                    </button>
                </div>
            ...
            <div className="sticky top-20 hidden lg:block  ">
                <div className="h-[505px] w-[312px] bg-white rounded-[15px] p-5 flex flex-col">
